...
const PlanItem = ({ title, text, image }) => {
  ...
  return (
    <div
      ref={ref}
      className={`relative bg-white rounded-lg shadow-md overflow-hidden group transition-all duration-500 ease-in-out ${
    ...
    >
      ...
      <div
        className={`absolute inset-0 transition duration-300 flex flex-col justify-center items-center text-center p-4 ${
          text ? 'bg-black/30 group-hover:bg-black/50' : 'bg-black/0 group-hover:bg-black/50'
        }`}
      >
